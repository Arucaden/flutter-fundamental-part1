...
class HomePage extends StatelessWidget {
  final List<Item> items = [
    Item(
      ...
      price: 5000,
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPOC2VuQNsuhTgONrk6ecDJe-jmHZG_3WWog&s',
      stock: 10,
      rating: 4.5,
    ),
    Item(
      name: 'Salt',
      price: 2000,
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSo3wsUoaYNgOAl0rfRnZ1Y-MnkQbCJ5px7FQ&s',
      stock: 20,
      rating: 4.0,
    ),
    Item(
